(function (global, factory) {
    ...
    class FiberRootNode {
        constructor(container, hostRootFiber) {
            ...
            Object.defineProperty(this, "pendingLanes", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: void 0
            });
            Object.defineProperty(this, "finishedLane", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: void 0
    ...
    function childReconciler(shouldTrackEffects) {
        ...
        // 暂未使用
        returnFiber, exiStingChildren, index, 
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        element) {
            var _a;
            const keyToUse = element.key !== null ? element.key : index;
            const before = (_a = exiStingChildren.get(keyToUse)) !== null && _a !== void 0 ? _a : null;
        ...
        return function reconcileChildFibers(returnFiber, currentFiber, newChild) {
            // 判断一下Fragment
            const isUnkeyTopLevelFragment = typeof newChild === "object" &&
                newChild.type === REACT_FRAGMENT_TYPE &&
                newChild.key === null;
            if (isUnkeyTopLevelFragment) {
                console.warn("我是fragment");
                newChild = newChild === null || newChild === void 0 ? void 0 : newChild.props.children;
            }
            // 判断 当前fiber的类型
    ...
    function updateFragment$1(returnFiber, currentFiber, elements, key, exiStingChildren) {
        let fiber = null;
    ...
    function recordHostChildToDelete(childrenToDelete, unmountFiber) {
        // 1.找到第一个rootHost节点
    ...
    function markUpateOnFiberToRoot(root, lane) {
     ...
     */
    function perfornmSyncWorkOnRoot(root, lane) {
